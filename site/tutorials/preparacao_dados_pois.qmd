---
title: "Preparação de dados de Pontos de Interesse (POI's)"
...
sf::write_sf(osm_pois_points_categorizados, 'sandbox/aula_geomarketing02/processed/osm_pois_pts_categ.gpkg')
sf::write_sf(setores_sjb_wgs84ll, 'sandbox/aula_geomarketing02/processed/setores_sjb_wgs84ll.gpkg')
sf::write_sf(supermarket_points, 'sandbox/aula_geomarketing02/processed/supermarket_grussai_points.gpkg')
writexl::write_xlsx(tab_categoria, 'sandbox/aula_geomarketing02/processed/tab_categoria.xlsx')

# Salvando em formatos do R
readr::write_rds(osm_pois_points_categorizados, 'sandbox/aula_geomarketing02/processed/osm_pois_pts_categ.rds')
readr::write_rds(setores_sjb_wgs84ll, 'sandbox/aula_geomarketing02/processed/setores_sjb_wgs84ll.rds')
readr::write_rds(supermarket_points, 'sandbox/aula_geomarketing02/processed/supermarket_grussai_points.rds')
readr::write_rds(tab_categoria, 'sandbox/aula_geomarketing02/processed/tab_categoria.rds')
...
tmap_save(mapa, filename = 'sandbox/aula_geomarketing02/processed/mapa.png')
...
# Salvando em formatos do R
readr::write_rds(aula_ls, 'sandbox/aula_geomarketing02/processed/aula_ls.rds')
