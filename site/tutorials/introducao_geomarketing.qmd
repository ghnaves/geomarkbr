...
base <- gm_join_data(dados, setores)
```
...
tm_temp =  gm_plot_basic(base, pop_abs, "População por setor")
tmap_save(tm = tm_temp, filename = "output/Populacao_por_setor.png", 
          width = 20,
          height = 14,
          units = 'cm')
```

![População por setor censitário. Campos dos Goytacazes, 2022](output/Populacao_por_setor.png){#fig-pop_setor width=80% fig-align="center"}
